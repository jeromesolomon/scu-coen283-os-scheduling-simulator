...
class MachineShortestProcessFirst(Machine):
    """
    ...
    def __shortest_process_in_ready_queue(self):
        """
        ...
        # loop through the ready queue to find the smallest cpu burst value
    ...
    def process_ready_queue(self):
        ...
        while self.cpu_is_available() and (len(self.ready) > 0):
            ...
            shortestIndex = self.__shortest_process_in_ready_queue()
    ...
    def process_all(self):
        ...
        # move the shortest cpu-burst process in the ready queue on to an available CPU core
